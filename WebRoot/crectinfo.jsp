...
<div id="container">
  <div id="header">
    <img src="images/1/101.gif" width="57" height="38"/>&nbsp;中国胶带在线超大集群用户资料修改
  <!-- end #header --></div> 
  <div id="alert">
      <%
		  ...
		  if (errorMsg != null) {
		      out.println("提示：修改资料失败，"+errorMsg.toString());
          }
      %>
  </div>
  <div id="mainContent">     
     <form id="form4" name="form4" method="post" action="crectinfo" onsubmit="checke()">
        <table align="center" cellpadding="0" cellspacing="5" id="maintable">
           <tr>
               <td width="295" class="right">您的号码：</td>
               <td width="448" class="left">
			        <% 
					   String str=(String)session.getAttribute("userwith");
					   int i=str.indexOf("(");                        
					   int j=str.indexOf(">");
					   String sNum=str.substring(i+1,i+6);
					   String sPhoto=str.substring(0,j);
					   sPhoto=sPhoto.replaceAll("width='18' height='18'","width='32' height='32'");
					   String sName=str.substring(j+1,i); 
					   out.print(sNum);
					%>
               </td>
           </tr>
           <tr>
               ...
               <td width="448" class="left">
                 <input name="oname" id="oname" type="text" class="tdwidth" value="<%=sName%>"/>
          *</td>
           </tr>
           <tr>
               <td class="right">头&nbsp;&nbsp;&nbsp;&nbsp;像：
                   <div>           
                      <input name="pho" id="pho" type="button" value="更多头像" onclick="photohide()"/>
           ...
           <tr>
               ...
               <td class="left" >
                 <input name="passwold" id="passwold" type="password" class="tdwidth"/> *
               </td>
           </tr>
           <tr>
